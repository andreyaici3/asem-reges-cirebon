<x-app-layout menuActive="pelanggan" menuOpen="">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('mekanik.pelanggan') }}">Data Pelanggan</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <form method="POST" action="{{ route('mekanik.pelanggan.update', ["id" => $customer->id]) }}">
                        @csrf
                        @method('put')
                        @include("mekanik.pelanggan.form")
                    </form>
                </div>
            </div>
        </div>
