            ...
            <nav class="mt-2">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'superuser')
                        ...
                        <li class="nav-item">
                            <a href="{{ route('super.cabang') }}"
                                class="nav-link {{ $menuActive == 'branch' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('super.admin') }}"
                                class="nav-link {{ $menuActive == 'admin' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('super.kepala') }}"
                                class="nav-link {{ $menuActive == 'maping' ? 'active' : '' }}">
                    ...
                    @if (Auth::user()->role == 'superadmin' ||
                        ...
                        <li class="nav-item {{ $menuOpen == 'karyawan' ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.karyawan', ['type' => 'gudang']) }}"
                                        class="nav-link {{ $menuActive == 'gudang' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Gudang</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.karyawan', ['type' => 'kasir']) }}"
                                        class="nav-link {{ $menuActive == 'kasir' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Kasir</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.karyawan', ['type' => 'mekanik']) }}"
                                        class="nav-link {{ $menuActive == 'mekanik' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Mekanik</p>
                                    </a>
                                </li>
                    ...
                    @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'superuser' || Auth::user()->role == 'gudang')
                        ...
                        <li class="nav-item">
                            <a href="{{ route('gudang.vendor') }}"
                                class="nav-link {{ $menuActive == 'vendor' ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ $menuOpen == 'car' ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('gudang.mobil.merk') }}"
                                        class="nav-link {{ $menuActive == 'merk-mobil' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Merk Mobil</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ $menuOpen == 'produk' ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('gudang.produk.merk') }}"
                                        class="nav-link {{ $menuActive == 'merk' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Merk Produk</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('gudang.produk.master') }}"
                                        class="nav-link {{ $menuActive == 'master' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Produk</p>
                                    </a>
                                </li>
                    ...
                    @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'superuser' || Auth::user()->role == 'mekanik')
                        ...
                        <li class="nav-item">
                            <a href="{{ route('mekanik.pelanggan') }}"
                                class="nav-link {{ $menuActive == 'pelanggan' ? 'active' : '' }}">
                                <i class="fas fa-user-astronaut nav-icon"></i>
                                <p>
                                    Data Customer
                                </p>
                    ...
                    @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'superuser' || Auth::user()->role == 'kasir')
                        ...
                        <li class="nav-item">
                            <a href="{{ route('kasir.riwayat') }}"
                                class="nav-link {{ $menuActive == 'riwayat' ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('auth.change') }}"
                            class="nav-link {{ $menuActive == 'ganti-password' ? 'active' : '' }}">
