                            ...
                            <form action="" method="post" id="myForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price_service"
                                        class="form-control {{ $errors->has('price_service') ? 'is-invalid' : '' }}"
                                        id="estimasi_jasa_pasang" placeholder="Jasa Service"
                                        aria-describedby="estimasi_jasa_pasang-error" aria-invalid="false"
                                        value="{{ old('price_service') ?? $data->price_service }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="estimasi_pengerjaan"
                                        class="form-control {{ $errors->has('price_service') ? 'is-invalid' : '' }}"
                                        id="keterangan" placeholder="Ex. 1 Hari, Selesai Hari Ini dll"
                                        aria-describedby="keterangan-error" aria-invalid="false"
                                        value="{{ $data->estimasi_pengerjaan }}">
